...
</script><form name="formAdd" method="post" action="<%=path %>/banjiinsert" class="form-horizontal" role="form">
	<fieldset> <legend>添加班级</legend>	

<div class="form-group">
             <label class="col-sm-2 control-label" for="name">班级名称</label>
              <div class="col-sm-4">
<input name="name" type="text" id="name" value="" placeholder="班级名称" class="form-control" >
     ...
     <legend></legend>
		<div class="form-group">
            <div class="col-sm-10 col-sm-offset-2">
			       <input name="forword" type="hidden" value="banjilist"/>
