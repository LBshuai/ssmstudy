...
</script><form name="formAdd" method="post" action="videoupdate" class="form-horizontal" role="form">
<fieldset> <legend>修改教学视频</legend>
...
<div class="form-group">
   <label class="col-sm-2 control-label" for="fujian">附件</label>
    <div class="col-sm-4">
	<input type="text" name="fujian" id="fujian" value="${c.fujian}" readonly class="form-control" placeholder="点击上传"/>
