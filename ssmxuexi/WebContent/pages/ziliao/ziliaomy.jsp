...
<table   class="table table-hover">
 <tr> <th>
<form name="formsea" class="form-inline" role="form" method="post" action="<%=path %>/ziliaomy">
...
<td>
 ...
 <a href="<%=path %>/ziliaoedit?id=${c.id}&forword=ziliaomy" class="btn btn-default">修改</a> |
 <a href="ziliaodel?id=${c.id}&forword=ziliaomy" onClick="return confirm('您确定要删除吗?')" class="btn btn-default">删除</a>
	       ...
	       function go(index)
           {
               window.location.href="<%=path %>/ziliaomy?index="+index;
           }
</script>
<table class="table table-hover table-striped table-bordered">
						        <tr>
