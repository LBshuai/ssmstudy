...
<table   class="table table-hover">
 <tr> <th>
<form name="formsea" class="form-inline" role="form" method="post" action="<%=path %>/ziliaolist">
...
<table class="table table-hover table-striped table-bordered">
 <tr><th>资料列表 &nbsp; &nbsp;
 <!--
 <button type="button" onclick="location.href='<%=path %>/ziliaoadd'" class="btn  btn-primary">添加</button>
 -->
</th></tr></table>
<table class="table table-hover table-striped table-bordered">
 <thead>
...
<td><a href="<%=path %>/ziliaoview?id=${c.id}" class="btn-default" target="_blank">查看详情</a></td>
<td> 
 <a href="<%=path %>/ziliaoedit?id=${c.id}&forword=ziliaolist" class="btn btn-default">修改</a> |
 <a href="ziliaodel?id=${c.id}&forword=ziliaolist" onClick="return confirm('您确定要删除吗?')" class="btn btn-default">删除</a>
 </td>
</tr></tbody>
</c:forEach> </table><script type="text/javascript">
	       function go(index)
           {
               window.location.href="<%=path %>/ziliaolist?index="+index;
           }
</script>
<table class="table table-hover table-striped table-bordered">
						        <tr>
