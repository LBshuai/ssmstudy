...
<table   class="table table-hover">
 <tr> <th>
<form name="formsea" class="form-inline" role="form" method="post" action="<%=path %>/studentlist">
...
<table class="table table-hover table-striped table-bordered">
 <tr><th>学生列表 &nbsp; &nbsp;
 <!--
 <button type="button" onclick="location.href='<%=path %>/studentadd'" class="btn  btn-primary">添加</button>
 -->
</th></tr></table>
<table class="table table-hover table-striped table-bordered">
 <thead>
...
<td> 
 <a href="<%=path %>/studentedit?id=${c.id}&forword=studentlist" class="btn btn-default">修改</a> |
 <a href="studentdel?id=${c.id}&forword=studentlist" onClick="return confirm('您确定要删除吗?')" class="btn btn-default">删除</a>
 </td>
</tr></tbody>
</c:forEach> </table><script type="text/javascript">
	       function go(index)
           {
               window.location.href="<%=path %>/studentlist?index="+index;
           }
</script>
<table class="table table-hover table-striped table-bordered">
						        <tr>
