...
<table   class="table table-hover">
 <tr> <th>
<form name="formsea" class="form-inline" role="form" method="post" action="<%=path %>/xuanzheAll">
...
<c:forEach items="${kinfo}" var="s"  varStatus="ss">
  ...
  <div class="form-group">
    <div class="col-sm-2">
	<input type="text" name="daan" id="daan" class="form-control" placeholder="正确答案"/>
	</div>
  </div>
  
  <div class="form-group">
    <div class="col-sm-2">
	<input type="text" name="fenshu" id="fenshu" class="form-control" placeholder="分数"/>
	</div>
  </div>
  
  <div class="form-group">
    <div class="col-sm-2">
	<input type="text" name="jiexi" id="jiexi" class="form-control" placeholder="答案解析"/>
	</div>
  </div>
...
<td>${c.jiexi}</td>
	       ...
	       function go(index)
           {
               window.location.href="<%=path %>/xuanzheAll?index="+index;
           }
</script>
<table class="table table-hover table-striped table-bordered">
						        <tr>
