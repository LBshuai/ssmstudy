...
</script><form name="formAdd" method="post" action="xuanzheupdate" class="form-horizontal" role="form">
<fieldset> <legend>修改选择题</legend>
...
<div class="form-group">
    <label class="col-sm-2 control-label" for="a">选项A</label>
      <div class="col-sm-4">
<input name="a" type="text" id="a"  value="${c.a}"  class="form-control" >
 </div>
	</div>
...
<div class="form-group">
    <label class="col-sm-2 control-label" for="b">选项B</label>
      <div class="col-sm-4">
<input name="b" type="text" id="b"  value="${c.b}"  class="form-control" >
 </div>
	</div>
...
<div class="form-group">
    <label class="col-sm-2 control-label" for="c">选项C</label>
      <div class="col-sm-4">
<input name="c" type="text" id="c"  value="${c.c}"  class="form-control" >
 </div>
	</div>
...
<div class="form-group">
    <label class="col-sm-2 control-label" for="d">选项D</label>
      <div class="col-sm-4">
<input name="d" type="text" id="d"  value="${c.d}"  class="form-control" >
 </div>
	</div>
...
<div class="form-group">
    <label class="col-sm-2 control-label" for="daan">正确答案</label>
      <div class="col-sm-4">
<input name="daan" type="text" id="daan"  value="${c.daan}"  class="form-control" >
 </div>
	</div>
<div class="form-group">
   <label class="col-sm-2 control-label" for="fenshu">分数</label>
    <div class="col-sm-4">
	<input name="fenshu" type="text" id="fenshu" value="${c.fenshu }" class="form-control"  onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"  >
	</div>
	</div>
...
<div class="form-group">
    <label class="col-sm-2 control-label" for="jiexi">答案解析</label>
      <div class="col-sm-4">
<input name="jiexi" type="text" id="jiexi"  value="${c.jiexi}"  class="form-control" >
 </div>
	</div>
