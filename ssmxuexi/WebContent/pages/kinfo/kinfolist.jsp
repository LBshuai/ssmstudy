...
<table   class="table table-hover">
 <tr> <th>
<form name="formsea" class="form-inline" role="form" method="post" action="<%=path %>/kinfolist">
...
<table class="table table-hover table-striped table-bordered">
 <tr><th>课程列表 &nbsp; &nbsp;
 <!--
 <button type="button" onclick="location.href='<%=path %>/kinfoadd'" class="btn  btn-primary">添加</button>
 -->
</th></tr></table>
<table class="table table-hover table-striped table-bordered">
 <thead>
...
<td> 
 <a href="<%=path %>/kinfoedit?id=${c.id}&forword=kinfolist" class="btn btn-default">修改</a> |
 <a href="kinfodel?id=${c.id}&forword=kinfolist" onClick="return confirm('您确定要删除吗?')" class="btn btn-default">删除</a>
 </td>
</tr></tbody>
</c:forEach> </table><script type="text/javascript">
	       function go(index)
           {
               window.location.href="<%=path %>/kinfolist?index="+index;
           }
</script>
<table class="table table-hover table-striped table-bordered">
						        <tr>
